...
public class ClientRunnable implements Runnable {
    ...
    public ClientRunnable(String name, Socket socket) throws IOException {
        this.name = name;
        this.socket = socket;
    ...
    public void run() {
        try {
            ...
            System.err.println("error in ClientRunnable");
            io.printStackTrace();
        } finally {
            try {
                socket.close();
            } catch (IOException fio) {
                System.err.println("error in ClientRunnable close socket");
                fio.printStackTrace();
            }
        }
    }
