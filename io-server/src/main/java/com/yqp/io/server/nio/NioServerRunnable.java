...
public class NioServerRunnable implements Runnable {
    ...
    public NioServerRunnable(int port) throws IOException {
    ...
    public void run() {
        try {
            ...
            System.err.println("error in NioServerRunnable");
            e.printStackTrace();
        } finally {
            try {
                ...
                System.err.println("error in NioServerRunnable close channel/selector");
                fio.printStackTrace();
            }
